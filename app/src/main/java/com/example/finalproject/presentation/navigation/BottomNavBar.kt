...
import com.example.finalproject.presentation.ui.screen.home.guidepage.UserGuideDetailsScreen
...
fun BottomNavBar() {
    ...
    { paddingValues ->
        ...
        NavHost(
            ...
            composable<UserGuideDetailsDestination> {
                val guideId = it.arguments?.getInt("guideId")
                UserGuideDetailsScreen(guideId!!)
            }
            ...
            composable<SettingsScreenDestination> {
                ...
                SettingsScreen(
                    ...
                    navigateToThemes = { navigationController.navigate(ThemeScreenDestination) },
