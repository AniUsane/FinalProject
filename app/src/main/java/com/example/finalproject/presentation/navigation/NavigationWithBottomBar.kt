...
import com.example.finalproject.presentation.ui.screen.Screens
import com.example.finalproject.presentation.ui.screen.booking.Booking
import com.example.finalproject.presentation.ui.screen.home.Home
import com.example.finalproject.presentation.ui.screen.profile.Profile
import com.example.finalproject.presentation.ui.screen.suggestion.Suggestion
...
@Composable
fun MyBottomAppBar(onToTripDestination: () -> Unit) {
    ...
    Scaffold(
                ...
                BottomAppBar(
                    ...
                    IconButton(
                        onClick = {
                            ...
                            navigationController.navigate(Screens.Suggestion.screen) {
                                popUpTo(navigationController.graph.startDestinationId)
                            }
                        }, modifier = Modifier.weight(1f)
                    ) {
        ...
        NavHost(
            ...
            composable(Screens.Suggestion.screen) { Suggestion() }
